...
data <- data %>%
  select(mortality, age, mother_years_ed, mothers_age, birth_order, male, spei3, spei12, spei36) %>%
  na.omit %>%
...
save(mod12, file='~/mod-results/mod12_new.Rdata')

system('/home/matt/telegram.sh "12 Smooths Done!"')
