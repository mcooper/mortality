...
mm <- sparse.model.matrix(formula(paste0("mortality ~ age + mother_years_ed + mothers_age + ",
                         ...
                         " + birth_order + male + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei24.tc.afr.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ age + mother_years_ed + mothers_age + ",
                         ...
                         " + birth_order + male + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei03.ch.afr.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ age + mother_years_ed + mothers_age + ",
                         ...
                         " + birth_order + male + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei24.ch.afr.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ ",
                         ...
                         " + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei03.tc.afr.noloc.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ ",
                         ...
                         " + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei24.tc.afr.noloc.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ ",
                         ...
                         " + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei03.ch.afr.noloc.Rdata')
rm(mm)
...
mm <- sparse.model.matrix(formula(paste0("mortality ~ ",
                         ...
                         " + cc*year")), data=data)
mod <- glmnet(mm, data$mortality, family='binomial', alpha=0, lambda=0)
save(mod, file='~/mortalityblob/glmnet/spei24.ch.afr.noloc.Rdata')
rm(mm)
